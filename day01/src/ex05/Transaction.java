...
public class Transaction {
    ...
    public void printTransaction() {
        if (getCategory() == TransferCategory.DEBITS) {
            System.out.println("From " + getRecipient().getName() + "(id = "
                    + getRecipient().getId() + ") +" + amount + " with id = " + getId());
        } else if (getCategory() == TransferCategory.CREDITS) {
            System.out.println("To " + getSender().getName() + "(id = "
                    + getSender().getId() + ") -" + amount + " with id = " + getId());
        }
    }
